...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`bg-white/95 border-r border-slate-200/80 transition-all duration-300 fixed left-0 z-50 md:z-40 shadow-sm ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 ${isCollapsed ? 'w-16 md:w-20' : 'w-64'
            ...
            <nav className="space-y-1.5 flex-1 overflow-y-auto">
              ...
              {(userRole === 'admin' || userRole === 'hod') && (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl transition font-semibold text-xs md:text-sm ${activeView === 'dashboard'
              ...
              {(userRole === 'admin' || userRole === 'hod') && (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl transition font-semibold text-xs md:text-sm ${activeView === 'users'
                      ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-md shadow-orange-500/20'
                      : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                    }`}
                >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl transition font-semibold text-xs md:text-sm ${activeView === 'board'
                    ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-md shadow-orange-500/20'
                    : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                  }`}
              >
              ...
              <div className="space-y-1">
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3.5 py-3 rounded-xl transition font-semibold text-xs md:text-sm ${isLeaveActive
                ...
                {isLeaveDropdownOpen && !isCollapsed && (
                  <div className="pl-6 space-y-1 border-l-2 border-orange-200 ml-5 my-1">
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-xs font-bold transition flex items-center gap-2 ${activeView === 'leaves'
                    ...
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-xs font-bold transition flex items-center gap-2 ${activeView === 'departments-overview' || activeView === 'dept-detail'
                          ? 'bg-orange-500 text-white shadow-xs'
                          : 'text-slate-600 hover:bg-slate-100'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-xs font-bold transition flex items-center gap-2 ${activeView === 'faculty-profile'
                          ? 'bg-orange-500 text-white shadow-xs'
                          : 'text-slate-600 hover:bg-slate-100'
                        }`}
                    >
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl transition font-semibold text-xs md:text-sm ${activeView === 'chats'
                    ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-md shadow-orange-500/20'
                    : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                  }`}
              >
