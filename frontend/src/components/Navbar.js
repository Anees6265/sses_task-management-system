          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            {user?.role === 'admin' && (
              <button
                ...
                className="px-3 md:px-4 py-1.5 md:py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg hover:from-orange-600 hover:to-amber-600 transition font-medium text-xs md:text-sm flex items-center space-x-1 shadow-sm"
              >
                <span>👤</span>
            ...
            <button
              onClick={logout}
              className="px-3 md:px-4 py-1.5 md:py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg hover:from-orange-600 hover:to-amber-600 transition font-medium text-xs md:text-sm shadow-sm"
            >
              Logout
            </button>
          </div>
